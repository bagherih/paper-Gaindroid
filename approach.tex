...
%the algorithm in Fig.~\ref{alg:api-mismatch} 
...
The detector uses %the algorithm in Fig.~\ref{alg:apc-mismatch} 
...
The logic of the algorithm, %in Fig.~\ref{alg:prm-mismatch} 
