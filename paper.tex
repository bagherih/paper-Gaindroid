...
The experimental results also show that \@approach, which leverages a novel approach for gradually loading and analyzing classes as needed, %remarkably outperforms the existing techniques in terms of scalability.
