...
\def \@atitle{{\normalsize AID}{\small -ROID}}
\def \@approach{\textsc{AID-roid}}
\def \apptotal {3,571}

\input{kotlin}

\linespread{0.98}
\setlength{\textfloatsep}{2.0pt plus 2.0pt}
...
\title{AID-roid: Automated Incompatibility Detection for Android}
...
We applied \@approach to 3,571 real-world apps and compared the results of our analysis against the state-of-the-art techniques,
which corroborates that \@approach is up to 3 times more accurate (by $\text{F}_1$ score) than competing approaches.
