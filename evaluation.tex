...
these benchmarks report known vulnerabilities as part
of the benchmarks. These vulnerabilities serve as our
evaluation baseline. For example, we evaluate the
effectiveness of our approach by observing the number
of reported vulnerabilities in these two benchmarks
that \@approach can detect. If our approach detects
a new issue, we manually inspect whether the
issue is real.  
%
\commentws{See above whether my explanation is
sufficient.}
