...
%\commentty{Third, we may also need to highlight the benefits of GainDroid in terms of scalability. And mention that the key idea of improving efficiency is to incrementally load and analyze classes.}
...
%\@approach detects more occurrences and types of incompatibilities. The result also contains fewer false positives. 
